...
function message(){
	//alert('ajax'+userid);
	$.ajax({
		url:"/tp_dof/Get_mess.php?id="+userid,
		type:"GET",
		dataType:"html",
		success: function(data){
			...
			if(data!=""){
				...
				etat=1;
				$('.scroller').slimScroll({scrollTo:"1000000px"})
				user=0;
			}
			mss=setInterval(message,1000);
		},
		beforeSend: function(){
			clearInterval(mss);
			//alert(userid);
			...
			{
				//alert('ici');
			$('#mess').html('<div  style="padding-top:150px;text-align:center"><img src="/untitled/loading.gif" alt="veuillez patienter..." /></div>');
			}
		}
	})
...
$('.nav-link').bind('click',function(){
	var fd=$(this);
	$.ajax({
		url:"/tp_dof/view_parts/Clear_sess.php?id="+fd.attr('id'),
		type:"GET",
		dataType:"html",
		success: function(data){
			userid=fd.attr('id');
		...
		beforeSend: function(){
			...
			//alert("debt");
			//alert(userid);
			$('.chats').html('<li class="out"><strong style="margin-left:150px;margin-top:190px">Chargement en cours...</strong></li>');/*<div  style="padding-top:150px;text-align:center"><img src="http://ntas-services.com/couakam/FEGUIFUT_CONNECT/loading.gif" alt="veuillez patienter..." /></div>');*/
		}
	})
	//alert($(this).attr('id'))
	//alert($(this).attr('id'));
...
$.ajax({
		...
		beforeSend: function(){
			...
			user=1;
			//clearInterval(mss);
			/*$('#mess').html('<div  style="padding-top:150px;text-align:center"><img src="http://ntas-services.com/couakam/FEGUIFUT_CONNECT/loading.gif" alt="veuillez patienter..." /></div>');*/
		}
	})
